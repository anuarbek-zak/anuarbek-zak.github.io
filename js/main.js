(function($) {
  ...
  var langDict = {
    'en':{
      ...
      'aboutTable .data':['Full-Stack JS Developer','anuarbek.zak@gmail.com','Almaty'],
      'workTitle': 'My best works',
      ...
      'workList .link-div p': ['Platform for creating powerfull web plugins (Ruby on Rails, React, Node.js, SCSS, JQuery)',
      ...
      'Advertising service with big functionality - First part. (HTML, CSS, AngularJs, Plotly.js) <br> Code - https://github.com/anuarbek-zak/reklaman',
      'Advertising service with big functionality - Second part. (HTML, CSS, AngularJs, Plotly.js) <br> Code - https://github.com/anuarbek-zak/reklaman',
      ...
      'Online store for selling furniture with categories and functional admin panel. (AngularJS, NodeJs, MongoDB) <br> Code - https://github.com/anuarbek-zak/amabilis',
      ...
      'able .text-grey': [
      'Over 4.5 years of active learning web programming I have learned to write clean and optimized code and to google anything to solve different tasks (stack overflow is my best friend).'
      ,'Have an understanding of common design concepts, as well as experience in working with a team designer and the ability to work with Figma, Photoshop. My eye is trained to see and understand what deigner wants to be implemented.',
      'With HTML and CSS I communicate on "you". I love and am able to make beautiful animations. The words "adaptive", "cross-browser" layout do not cause shaking at the knees. I can use in my work such assembly systems as Webpack and Gulp. Worked with SCSS, LESS preprocessors for CSS.',
      'I know JS "like the back of my hand". I have a lot of experience in using modern frameworks and libraries like React, Angular and JQuery.',
      'I like front-end more, but I also know the back-end as well. I worked with Ruby on Rails, PHP , and I do all projects on my favorite Node.js using the Express framework and the Mongo database.'],
      'skill .title-small span': 'Skills',
      'skill .content-detail':'I have been working in web for more than 4.5 years and during this time I learned a lot.',
      'contact .title-small span':'Contacts',
      'contact .content-detail':'If you want to contact me, you can fill out the form. I will contact with you.',
